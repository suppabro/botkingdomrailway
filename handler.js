        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!user.rtrofi) user.rtrofi = 'ලෝකඩ'
            ...
            esteh: 0,
                ...
                if (chat) {
                    ...
                    welcome: true,
                    detect: false,
                    sWelcome: '@user Hellow Welcome To The Botkingdom',
                    sBye: '@user Bye',
                    sPromote: '',
                    sDemote: '',
                    delete: true,
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.reply(m.chat, `ඔබගේ සීමාව අවසන් වී ඇත*${usedPrefix}buy*`, m)
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'මෙම විධානය භාවිතා කළ හැක්කේ _*OWWNER!1!1!*_',
